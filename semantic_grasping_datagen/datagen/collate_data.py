...
def main():
    ...
    with open(dataset_path, "w", newline='') as f:
        writer = csv.writer(f)
        writer.writerow(["scene_path", "annotation_id", "scene_id", "view_id", "obs_id", "rgb_key", "xyz_key", "annot_key", "grasp_pose_key", "annot"])
            ...
            with h5py.File(os.path.join(args.observation_dir, scene_file), "r") as f:
                for view_id in f.keys():
                    ...
                    for obs_id in f[view_id].keys():
                        ...
                        writer.writerow([scene_file, annot_id, scene_id, view_id, obs_id, rgb_key, xyz_key, annot_key, grasp_pose_key, annot])
