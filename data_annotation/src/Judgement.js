...
const Judgement = () => {
  ...
  const handleSubmit = async () => {
    ...
    const currentJudgement =
      judgementSchedule.judgements[judgementSchedule.idx];

    const category = currentJudgement.category;
    const objectId = currentJudgement.object_id;
    const graspId = currentJudgement.grasp_id;
    const userId = currentJudgement.user_id;
    const studyId = currentJudgement.study_id || "";
    const judgerUserId =
      currentJudgement.judger_id ||
      searchParams.get("judger_id") ||
      "anonymous";
